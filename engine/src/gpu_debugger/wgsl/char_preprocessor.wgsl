...
const NUMBER_OF_DRAW_INDIRECTS = 1024u;
const NUMBER_OF_THREADS = 1024u;
...
fn main(@builtin(local_invocation_id)    local_id: vec3<u32>,
    ...
    for (var i: u32 = 0u; i < number_of_chunks; i = i + 1u) {
        ...
        if (global_index < wg_char_params.iterator_end) {
            ...
            let vertex_count_per_char = min(u32(f32(wg_char_params.max_points_per_char) / f32(pow(dist, 1.7))), char_params[0].max_points_per_char);
